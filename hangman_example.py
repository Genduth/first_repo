...
WORDLIST_FILENAME = "sample_words.txt"
    ...
    * After each guess, you should display to the user the 
    ...
    while guesses_remaining > 0:
        ...
        if len(guess) != 1 or not guess.isalpha():
            print("Oops! That is not a valid letter. Please enter a single letter.")
            continue
...
if __name__ == "__main__":
    # Test if words are loading correctly
    print("Testing word loading...")
    print(f"Number of words loaded: {len(wordlist)}")
    print(f"First 5 words: {wordlist[:5]}")
    print()
